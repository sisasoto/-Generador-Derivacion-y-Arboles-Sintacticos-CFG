"""En cada paso se expande el NO-TERMINAL más a la derecha de la forma sentencial actual. Esto corresponde a un recorrido en
...
class DerivacionDerecha(Derivacion):
    ...
    def _ultimo_no_terminal(self, forma: list[NodoArbol]) -> int:
        """Encuentra el índice del último no-terminal (nodo con hijos)en la forma sentencial actual.
        Recorre de derecha a izq. Devuelve indice del último no-terminal, o -1 si todos son terminales."""
