...
Emite señales PyQt5 al terminar o al encontrar un error,
para que VentanaPrincipal actualice la interfaz sin bloquearla.
"""
...
class HiloDerivacion(QThread):
    ...
    Signals:
        resultado_listo: Emitido con (pasos, raiz_arbol, raiz_ast) al terminar.
    ...
    def __init__(self,
                 ...
                 parent=None) -> None:
        """
        Inicializa el hilo con los datos necesarios para el cálculo.

        Args:
            gramatica: Objeto Gramatica ya construido.
            expresion: La expresión objetivo a derivar.
            tipo_derivacion: 'izquierda' o 'derecha'.
            parent: Widget padre (opcional, para gestión de memoria Qt).
        """
